...
class AppFont {
  ...
  // semibold black
  static final semibold_black = semibold.copyWith(color: AppColors.black);
  static final semibold_black_30 = semibold_black.copyWith(fontSize: 30);
  // semibold green
  static final semibold_green = semibold.copyWith(color: AppColors.green);
  static final semibold_green_12 = semibold_green.copyWith(fontSize: 12);
  // oswald
